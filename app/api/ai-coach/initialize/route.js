  ...
  try {
    ...
    const averageScore =
      totalInterviews > 0
        ? Math.round(
            interviews.reduce(
              (sum, int) => sum + (int.aiSummary?.score || 0),
              0
            ) / totalInterviews
          )
        : 0;
...
Keep it concise and motivational.`;
        ...
        messages: [
          {
            role: "system",
            content:
              "You are an enthusiastic AI Learning Coach who helps developers improve their skills. Be encouraging, specific, and actionable.",
          },
          {
            role: "user",
    ...
    const welcomeMessage =
      ...
      `Hello ${
        user?.name || "there"
      }! 👋 I'm your AI Learning Coach. I'm here to help you improve your coding skills based on your interview performance and learning progress. What would you like to work on today?`;
    ...
    return NextResponse.json(
      {
        success: true,
        welcomeMessage:
          "Hello! 👋 I'm your AI Learning Coach. I'm here to help you improve your coding skills and guide your learning journey. How can I assist you today?",
      },
      { status: 200 }
    );
  }
